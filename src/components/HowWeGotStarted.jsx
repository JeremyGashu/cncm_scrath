...
const HowWeGotStarted = () => {
    return (
        <Box sx={{ backgroundColor: '#1D212A', pt: 5 }}>
            ...
            <Grid container sx={{ position: 'relative', bottom: '200px', m: 3, p: 3 }} justifyContent='space-between' alignItems='center'>
                <Grid item lg={3} sx={{ pl:8, my:2}}>
                    <img style={{ maxHeight: 250 }} src={cncm_white} />
                </Grid>
