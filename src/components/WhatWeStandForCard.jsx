...
const WhatWeStandForCard = ({ image, title, text }) => {
    return <Box sx={{  borderRadius: 2, m: 2, width: 300, height: 300, backgroundColor: 'white', px: 3, py: 5, display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexDirection: 'column', }}>
