...
const WhatWeCoverCard = ({ image, title, text }) => {
    return <Box sx={{ boxShadow: 'rgba(100, 100, 111, 0.2) 0px 7px 29px 0px', borderRadius: 2, m: 1, width: 250, height: 310, backgroundColor: 'white', px: 2, pt: 4, display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexDirection: 'column' }}>
