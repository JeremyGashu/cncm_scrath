    ...
    return (
        <Box sx={{ backgroundColor: 'black', p: 5, }}>
            <Grid container justifyContent='space-evenly' alignItems='center' gap={2}>
                <Grid item lg={5} sm={12} sx={{p:3}}>
                    <Typography sx={{ fontSize: 37, fontWeight: 'bold', color: '#1DEF55' }}>Solutions &amp; Packages</Typography>
                    <Typography sx={{ fontSize: 20, fontWeight: 'bold', color: 'white', }}>CNCM provides the community</Typography>
                    <Typography sx={{ fontSize: 20, fontWeight: 'bold', color: 'white', }}>support, debate and foster the work of</Typography>
                    <Typography sx={{ fontSize: 20, fontWeight: 'bold', color: 'white', }}>all members</Typography>
